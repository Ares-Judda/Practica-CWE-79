...
if (!isset($_SESSION['user'])) {
    echo "<p>No tiene permiso de ver esta pagina. <a href='login.php'>Iniciar sesión</a></p>";
    exit();
}
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-witcth, initial-scale=1.0">
    ...
    <body class="container mt-3">
        ...
        <p>Haga click en el vinculo Ver datos para ver la informacion completa de un estudiante</p>
